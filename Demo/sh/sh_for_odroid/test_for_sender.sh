...
--tab -e 'bash -c "sleep 5; roslaunch prometheus_control px4_pos_estimator.launch; exec bash"' \
--tab -e 'bash -c "sleep 5; roslaunch prometheus_control px4_sender.launch; exec bash"' \
