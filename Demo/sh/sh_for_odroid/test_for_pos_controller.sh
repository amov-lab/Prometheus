...
--tab -e 'bash -c "sleep 4; roslaunch prometheus_control px4_pos_estimator.launch; exec bash"' \
--tab -e 'bash -c "sleep 4; roslaunch prometheus_control px4_pos_controller.launch; exec bash"' \
