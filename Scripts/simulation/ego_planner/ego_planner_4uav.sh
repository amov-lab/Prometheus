...
--tab -e 'bash -c "sleep 6; roslaunch prometheus_gazebo sitl_indoor_4uav.launch gazebo_enable:=false uav1_init_x:=-10 uav1_init_y:=-10 uav2_init_x:=-10 uav2_init_y:=-5 uav3_init_x:=-10 uav3_init_y:=5 uav4_init_x:=-10 uav4_init_y:=10; exec bash"' \
