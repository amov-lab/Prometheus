...
roslaunch prometheus_demo sitl_outdoor_1uav_find_aruco_marker.launch & sleep 1s;
# 启动无人机控制 - uav_control_main
roslaunch prometheus_uav_control uav_control_main_outdoor.launch & sleep 1s;
# 启动视觉模块
roslaunch prometheus_demo aruco_datection.launch & sleep 1s;
# 启动无人机控制
roslaunch prometheus_demo find_aruco_marker.launch & sleep 1s;
