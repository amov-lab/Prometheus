...
void PriusHybridPlugin::OnPriusCommand(const simulation::Control::ConstPtr &msg)
{
  ...
  {
    case simulation::Control::NEUTRAL:
      this->dataPtr->directionState = PriusHybridPluginPrivate::NEUTRAL;
      break;
    case simulation::Control::FORWARD:
      this->dataPtr->directionState = PriusHybridPluginPrivate::FORWARD;
      break;
    case simulation::Control::REVERSE:
