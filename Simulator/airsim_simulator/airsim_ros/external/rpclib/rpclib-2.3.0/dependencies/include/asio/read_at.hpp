...
/**
 * @defgroup read_at clmdep_asio::read_at
 *
 ...
 * @code clmdep_asio::read_at(d, 42, clmdep_asio::buffer(data, size)); @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 *
 * @note This overload is equivalent to calling:
 * @code clmdep_asio::read_at(
 *     d, 42, buffers,
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code clmdep_asio::read_at(d, 42,
 *     clmdep_asio::buffer(data, size), ec); @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 *
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code clmdep_asio::read_at(d, 42, clmdep_asio::buffer(data, size),
...
/*@}*/
/**
 * @defgroup async_read_at clmdep_asio::async_read_at
 *
 ...
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code
 * clmdep_asio::async_read_at(d, 42, clmdep_asio::buffer(data, size), handler);
 * @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 *
 * @note This overload is equivalent to calling:
 * @code clmdep_asio::async_read_at(
 *     d, 42, buffers,
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code clmdep_asio::async_read_at(d, 42,
