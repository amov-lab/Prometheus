...
#else
  : public clmdep_asio::detail::service_base<stream_handle_service>
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit stream_handle_service(clmdep_asio::io_service& io_service)
    : clmdep_asio::detail::service_base<stream_handle_service>(io_service),
