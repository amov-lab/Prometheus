...
inline std::size_t write(SyncWriteStream& s, const ConstBufferSequence& buffers)
{
  ...
  clmdep_asio::detail::throw_error(ec, "write");
...
std::size_t write(SyncWriteStream& s,
    clmdep_asio::basic_streambuf<Allocator>& b,
    CompletionCondition completion_condition, clmdep_asio::error_code& ec)
{
...
namespace detail
{
  ...
  template <typename AsyncWriteStream,
      typename CompletionCondition, typename WriteHandler>
  class write_op<AsyncWriteStream, clmdep_asio::mutable_buffers_1,
      CompletionCondition, WriteHandler>
    : detail::base_from_completion_cond<CompletionCondition>
  {
  public:
    write_op(AsyncWriteStream& stream,
        const clmdep_asio::mutable_buffers_1& buffers,
        CompletionCondition completion_condition,
  ...
  template <typename AsyncWriteStream,
      typename CompletionCondition, typename WriteHandler>
  class write_op<AsyncWriteStream, clmdep_asio::const_buffers_1,
      CompletionCondition, WriteHandler>
    : detail::base_from_completion_cond<CompletionCondition>
  {
  public:
    write_op(AsyncWriteStream& stream,
        const clmdep_asio::const_buffers_1& buffers,
        CompletionCondition completion_condition,
        WriteHandler& handler)
      : detail::base_from_completion_cond<
          CompletionCondition>(completion_condition),
...
namespace detail
{
  ...
  {
  public:
    write_streambuf_handler(clmdep_asio::basic_streambuf<Allocator>& streambuf,
        WriteHandler& handler)
