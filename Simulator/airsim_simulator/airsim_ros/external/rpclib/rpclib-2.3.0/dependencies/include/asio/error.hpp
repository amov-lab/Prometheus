...
extern ASIO_DECL
const clmdep_asio::error_category& get_netdb_category();

extern ASIO_DECL
const clmdep_asio::error_category& get_addrinfo_category();

#else // !defined(ASIO_WINDOWS) && !defined(__CYGWIN__)

inline const clmdep_asio::error_category& get_netdb_category()
{
  return get_system_category();
}

inline const clmdep_asio::error_category& get_addrinfo_category()
{
  return get_system_category();
}
...
template<> struct is_error_code_enum<clmdep_asio::error::netdb_errors>
{
  static const bool value = true;
};

template<> struct is_error_code_enum<clmdep_asio::error::addrinfo_errors>
{
  static const bool value = true;
};

template<> struct is_error_code_enum<clmdep_asio::error::misc_errors>
{
  static const bool value = true;
};
...
inline clmdep_asio::error_code make_error_code(basic_errors e)
{
  return clmdep_asio::error_code(
      static_cast<int>(e), get_system_category());
}

inline clmdep_asio::error_code make_error_code(netdb_errors e)
{
  return clmdep_asio::error_code(
      static_cast<int>(e), get_netdb_category());
}

inline clmdep_asio::error_code make_error_code(addrinfo_errors e)
{
  return clmdep_asio::error_code(
      static_cast<int>(e), get_addrinfo_category());
}

inline clmdep_asio::error_code make_error_code(misc_errors e)
{
  return clmdep_asio::error_code(
