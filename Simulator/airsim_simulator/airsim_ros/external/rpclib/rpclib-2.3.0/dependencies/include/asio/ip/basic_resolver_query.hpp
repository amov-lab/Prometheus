...
/**
 * The clmdep_asio::ip::basic_resolver_query class template describes a query
...
public:
  ...
  const clmdep_asio::detail::addrinfo_type& hints() const
  {
    return hints_;
  }
...
private:
  clmdep_asio::detail::addrinfo_type hints_;
