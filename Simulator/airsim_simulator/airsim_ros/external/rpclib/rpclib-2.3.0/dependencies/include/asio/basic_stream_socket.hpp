...
public:
   ...
   */
  explicit basic_stream_socket(clmdep_asio::io_service& io_service)
   ...
   */
  basic_stream_socket(clmdep_asio::io_service& io_service,
   ...
   * @code
   * socket.send(clmdep_asio::buffer(data, size));
   * @endcode
   ...
   * To send a single data buffer use the @ref buffer function as follows:
   * @code
   * socket.send(clmdep_asio::buffer(data, size), 0);
   * @endcode
   * See the @ref buffer documentation for information on sending multiple
   * buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   * To send a single data buffer use the @ref buffer function as follows:
   * @code
   * socket.async_send(clmdep_asio::buffer(data, size), 0, handler);
   * @endcode
   * See the @ref buffer documentation for information on sending multiple
   * buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   * follows:
   * @code
   * socket.receive(clmdep_asio::buffer(data, size));
   * @endcode
   ...
   * follows:
   * @code
   * socket.receive(clmdep_asio::buffer(data, size), 0);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   * follows:
   * @code
   * socket.async_receive(clmdep_asio::buffer(data, size), 0, handler);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   * @code
   * socket.write_some(clmdep_asio::buffer(data, size));
   * @endcode
   ...
   * To write a single data buffer use the @ref buffer function as follows:
   * @code
   * socket.async_write_some(clmdep_asio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on writing multiple
   * buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   * @code
   * socket.read_some(clmdep_asio::buffer(data, size));
   * @endcode
   ...
   * To read into a single data buffer use the @ref buffer function as follows:
   * @code
   * socket.async_read_some(clmdep_asio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on reading into multiple
   * buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
