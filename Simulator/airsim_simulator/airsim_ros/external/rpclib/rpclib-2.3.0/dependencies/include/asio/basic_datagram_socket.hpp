...
public:
   ...
   * socket.
   */
  explicit basic_datagram_socket(clmdep_asio::io_service& io_service)
   ...
   */
  basic_datagram_socket(clmdep_asio::io_service& io_service,
   ...
   * @code socket.send(clmdep_asio::buffer(data, size)); @endcode
  ...
  std::size_t send(const ConstBufferSequence& buffers)
  {
    ...
    clmdep_asio::detail::throw_error(ec, "send");
    return s;
  }
   ...
   * To send a single data buffer use the @ref buffer function as follows:
   * @code
   * socket.async_send(clmdep_asio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on sending multiple
   * buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   * To send a single data buffer use the @ref buffer function as follows:
   * @code
   * clmdep_asio::ip::udp::endpoint destination(
   *     clmdep_asio::ip::address::from_string("1.2.3.4"), 12345);
   * socket.send_to(clmdep_asio::buffer(data, size), destination);
   * @endcode
   * See the @ref buffer documentation for information on sending multiple
   * buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
      ...
      const endpoint_type& destination)
  {
    ...
    clmdep_asio::detail::throw_error(ec, "send_to");
    return s;
  }
   ...
   *     clmdep_asio::buffer(data, size), destination, handler);
   * @endcode
   * See the @ref buffer documentation for information on sending multiple
   * buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   * follows:
   * @code socket.receive(clmdep_asio::buffer(data, size)); @endcode
  ...
  std::size_t receive(const MutableBufferSequence& buffers)
  {
    ...
    std::size_t s = this->get_service().receive(
        this->get_implementation(), buffers, 0, ec);
    clmdep_asio::detail::throw_error(ec, "receive");
    return s;
  }
   ...
   * follows:
   * @code
   * socket.async_receive(clmdep_asio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   * follows:
   * @code
   * clmdep_asio::ip::udp::endpoint sender_endpoint;
   * socket.receive_from(
   *     clmdep_asio::buffer(data, size), sender_endpoint);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
      ...
      endpoint_type& sender_endpoint)
  {
    ...
    clmdep_asio::detail::throw_error(ec, "receive_from");
    return s;
  }
   ...
   *     clmdep_asio::buffer(data, size), sender_endpoint, handler); @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   */
