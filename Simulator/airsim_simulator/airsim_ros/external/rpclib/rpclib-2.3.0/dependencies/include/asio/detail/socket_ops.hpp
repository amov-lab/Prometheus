...
ASIO_DECL int shutdown(socket_type s,
    int what, clmdep_asio::error_code& ec);
...
ASIO_DECL bool sockatmark(socket_type s, clmdep_asio::error_code& ec);

ASIO_DECL size_t available(socket_type s, clmdep_asio::error_code& ec);

ASIO_DECL int listen(socket_type s,
    int backlog, clmdep_asio::error_code& ec);
...
ASIO_DECL signed_size_type recv(socket_type s, buf* bufs,
    size_t count, int flags, clmdep_asio::error_code& ec);
...
ASIO_DECL size_t sync_send(socket_type s, state_type state,
    ...
    bool all_empty, clmdep_asio::error_code& ec);
...
ASIO_DECL int getsockopt(socket_type s, state_type state,
    ...
    size_t* optlen, clmdep_asio::error_code& ec);
...
ASIO_DECL int ioctl(socket_type s, state_type& state,
    int cmd, ioctl_arg_type* arg, clmdep_asio::error_code& ec);
...
ASIO_DECL const char* inet_ntop(int af, const void* src, char* dest,
    size_t length, unsigned long scope_id, clmdep_asio::error_code& ec);
...
ASIO_DECL int gethostname(char* name,
    int namelen, clmdep_asio::error_code& ec);

#if !defined(ASIO_WINDOWS_RUNTIME)

ASIO_DECL clmdep_asio::error_code getaddrinfo(const char* host,
    const char* service, const addrinfo_type& hints,
    addrinfo_type** result, clmdep_asio::error_code& ec);

ASIO_DECL clmdep_asio::error_code background_getaddrinfo(
...
ASIO_DECL clmdep_asio::error_code getnameinfo(
    const socket_addr_type* addr, std::size_t addrlen,
    char* host, std::size_t hostlen, char* serv,
    std::size_t servlen, int flags, clmdep_asio::error_code& ec);

ASIO_DECL clmdep_asio::error_code sync_getnameinfo(
    const socket_addr_type* addr, std::size_t addrlen,
    char* host, std::size_t hostlen, char* serv,
    std::size_t servlen, int sock_type, clmdep_asio::error_code& ec);

ASIO_DECL clmdep_asio::error_code background_getnameinfo(
    const weak_cancel_token_type& cancel_token,
    const socket_addr_type* addr, std::size_t addrlen,
    char* host, std::size_t hostlen, char* serv,
    std::size_t servlen, int sock_type, clmdep_asio::error_code& ec);
