...
public:
  ...
  clmdep_asio::error_code cancel(base_implementation_type&,
  ...
  clmdep_asio::error_code io_control(base_implementation_type&,
  ...
  clmdep_asio::error_code non_blocking(base_implementation_type&,
  ...
  clmdep_asio::error_code native_non_blocking(base_implementation_type&,
      bool, clmdep_asio::error_code& ec)
  {
    ec = clmdep_asio::error::operation_not_supported;
    return ec;
  ...
  clmdep_asio::error_code shutdown(base_implementation_type&,
...
protected:
  ...
  ASIO_DECL clmdep_asio::error_code do_connect(
      base_implementation_type& impl,
  ...
  ASIO_DECL std::size_t do_send(
      base_implementation_type& impl, const clmdep_asio::const_buffer& data,
      socket_base::message_flags flags, clmdep_asio::error_code& ec);
  ...
  ASIO_DECL std::size_t do_receive(
      base_implementation_type& impl, const clmdep_asio::mutable_buffer& data,
      socket_base::message_flags flags, clmdep_asio::error_code& ec);
