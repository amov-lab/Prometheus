...
struct stream_core
{
  ...
  clmdep_asio::deadline_timer pending_read_;

  // Timer used for storing queued write operations.
  clmdep_asio::deadline_timer pending_write_;

  // Helper function for obtaining a time value that always fires.
  static clmdep_asio::deadline_timer::time_type neg_infin()
  {
    return boost::posix_time::neg_infin;
  }

  // Helper function for obtaining a time value that never fires.
  static clmdep_asio::deadline_timer::time_type pos_infin()
  {
  ...
  // Timer used for storing queued write operations.
  clmdep_asio::steady_timer pending_write_;

  // Helper function for obtaining a time value that always fires.
  static clmdep_asio::steady_timer::time_point neg_infin()
  {
    return (clmdep_asio::steady_timer::time_point::min)();
  }

  // Helper function for obtaining a time value that never fires.
  static clmdep_asio::steady_timer::time_point pos_infin()
  {
