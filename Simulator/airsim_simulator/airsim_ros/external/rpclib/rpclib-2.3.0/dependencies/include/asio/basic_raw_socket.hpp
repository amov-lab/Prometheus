...
public:
   ...
   * socket.
   */
  explicit basic_raw_socket(clmdep_asio::io_service& io_service)
   ...
   */
  basic_raw_socket(clmdep_asio::io_service& io_service,
   ...
   *     clmdep_asio::buffer(data, size), 0, sender_endpoint, handler); @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   */
