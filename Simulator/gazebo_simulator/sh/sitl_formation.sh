...
--tab -e 'bash -c "sleep 5; roslaunch prometheus_experiment prometheus_formation_control.launch; exec bash"' \
--tab -e 'bash -c "sleep 6; roslaunch prometheus_experiment prometheus_formation_setmode.launch; exec bash"' \
