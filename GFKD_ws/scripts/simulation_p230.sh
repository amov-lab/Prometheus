...
--tab -e 'bash -c "sleep 3; roslaunch prometheus_gfkd px4_sitl.launch uav1_init_x:=-6.0 uav1_init_y:=-7.0; exec bash"' \
--tab -e 'bash -c "sleep 3; roslaunch prometheus_uav_control uav_control_main_indoor.launch; exec bash"' \
