...
gnome-terminal -x bash -c "cd ~/maplab_original_ws/ && source devel/setup.bash && rosrun rovioli tutorial_sineva_live /home/colin/datasets/Localization_maps_maplab/d1000-maplab" &
