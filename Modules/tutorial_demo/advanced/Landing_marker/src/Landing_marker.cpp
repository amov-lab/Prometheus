...
inline void topicSub(ros::NodeHandle &nh)
{
    ...
    static ros::Subscriber landpad_det_sub = nh.subscribe<spirecv_msgs::TargetsInFrame>("/uav" + std::to_string(g_uav_id) + "/spirecv/landing_marker_detection", 10, landpadDetCb);
