...
int main(int argc, char **argv)
{
    ...
    while (ros::ok()) 
    {
        ...
        cout << "Please choose the action: 0 for Hold, 1 for Direct Control BODY, 2 for Direct Control ENU , 3 for Point Control, 4 for Test 9 for astar goal pub..."<<endl;
        cin >> start_flag;
        if (start_flag == 0)
        {
        ...
        else if (start_flag == 1)
        {
            ...
            ugv_cmd.Mode = prometheus_msgs::UgvCommand::Direct_Control_BODY;
        ...
        else if (start_flag == 2)
        {
            ...
            ugv_cmd.Mode = prometheus_msgs::UgvCommand::Direct_Control_ENU;
            ugv_cmd.linear_vel[0] = state_desired[0];
            ugv_cmd.linear_vel[1] = state_desired[1];
        ...
        {
            ugv_cmd.Mode = prometheus_msgs::UgvCommand::Test;
            command_pub.publish(ugv_cmd);
        }
