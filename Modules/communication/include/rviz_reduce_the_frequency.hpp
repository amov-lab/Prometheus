...
private:
    ros::Subscriber octomap_point_cloud_centers_sub_,occupancy_inflate_sub_,scan_sub_,scan_filtered_sub_,trajectory_sub_,odom_sub_;
    ...
    ros::Timer send_timer_1000MS,send_timer_200MS,send_timer_500MS;
};
